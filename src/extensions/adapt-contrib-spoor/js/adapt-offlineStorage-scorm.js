  ...
  Adapt.offlineStorage.initialize({
    ...
    get: function(name) {
      ...
      switch (name.toLowerCase()) {
        ...
        case "reflection_data":
          reflectionData = this.getCustomState('r');
          return reflectionData || ''; 
          //return scorm.getReflectionData();
        case "score":
        ...
        case "sliders_array_start":
          return scorm.getSlidersArrayStart();
        case "sliders_array_end":
          return scorm.getSlidersArrayEnd();
        case "completion":
          courseState = this.getCustomState('c');
    ...
    set: function(name, value) {
      ...
      switch (name.toLowerCase()) {
        ...
        case "sliders_array_start":
          return scorm.setSlidersArrayStart.apply(scorm, args);
        case "sliders_array_end":
          return scorm.setSlidersArrayEnd.apply(scorm, args);
        // case "reflection_data":
        //   return scorm.setReflectionData.apply(scorm, args);
        case "score":
