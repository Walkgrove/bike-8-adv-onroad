define ([
  ...
  */
  ...
  ScormWrapper.prototype.setSlidersArrayStart = function(_value) {
    this.setValue(this.isSCORM2004() ? "cmi.sliders_array_start" : "cmi.core.sliders_array_start", _value);
  };

  ScormWrapper.prototype.setSlidersArrayEnd = function(_value) {
    this.setValue(this.isSCORM2004() ? "cmi.sliders_array_end" : "cmi.core.sliders_array_end", _value);
  };
  ...
  ScormWrapper.prototype.getSlidersArrayStart = function() {
    return this.getValue(this.isSCORM2004() ? "cmi.sliders_array_start" : "cmi.core.sliders_array_start");
  };

  ScormWrapper.prototype.getSlidersArrayEnd = function() {
    return this.getValue(this.isSCORM2004() ? "cmi.sliders_array_end" : "cmi.core.sliders_array_end");
  };

  ScormWrapper.prototype.getIsLMSConnected = function() {
    if(this.lmsConnected) {
      let isLMSConnected = true;

      if(this._isLXP === false) {
        isLMSConnected = this.getValue("cmi.core.isLMSConnected") ? this.getValue("cmi.core.isLMSConnected") : false;
      }
      // console.log('>>> lmsConnected is true >>> IsLMSConnected:', isLMSConnected, Boolean(isLMSConnected));

      return Boolean(isLMSConnected);
    }
    //console.log('>>> lmsConnected is false >>> returning IsLMSConnected as false');
    return false;
  };
  ...
  ScormWrapper.prototype.commit = function() {
    ...
    this.isLMSConnected = this.getIsLMSConnected();

    if (this.lmsConnected && this.isLMSConnected) {
  ...
  */
  ...
  ScormWrapper.prototype.handleError = function(_msg) {
    ...
    // add element to prevent progression
    $('body').append("<div style='z-index:1000; position:fixed;width:100%;height: 100%;top:0;left:0;background-color: white;justify-content: center;align-items: center;display: flex;text-align: center; flex-direction: column;'>Your connection has been lost and your progress may no longer be stored.<br/><br/><strong>Please close the course and relaunch.</strong></div>");
