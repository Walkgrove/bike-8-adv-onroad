...
(function(root, factory) {
    ...
    /* -------------------------------------------------------------------------
       pipwerks.SCORM.connection.checkCon()
       Tells the LMS to check the svelte connection.

       Parameters:  None
       Returns:     Boolean
    ---------------------------------------------------------------------------- */

    // pipwerks.SCORM.connection.checkCon = function() {
    ...
    //     trace("connection.checkCon called.");

    //     if(scorm.connection.isActive) {
    //         // var checkAPI = scorm.API.getHandle();
    //         // if (checkAPI) {
    //         //     success = makeBoolean(checkAPI.SvelteLMSConnection(""));
    //         // }
    //         // trace(success);
    //         return "true";
    //     } else {
    ...
    pipwerks.SCORM.checkConnection = pipwerks.SCORM.connection.checkCon;
