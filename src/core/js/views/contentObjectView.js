define([
  ...
  class ContentObjectView extends AdaptView {
    ...
    onDeviceChanged() {
     ...
     setHeroImage() {
      if (screen.width < '700') {
        this.$('.page__header-inner').attr('style','background: url(' + this.model.get('_hero_mobile') + ');background-size:contain;background-repeat: no-repeat;');
        this.$('.hero-image').attr('src', this.model.get('_hero_mobile'));
      } else {
        this.$('.page__header-inner').attr('style','background: url(' + this.model.get('_hero') + ');background-size:contain;background-repeat: no-repeat;');
        this.$('.hero-image').attr('src', this.model.get('_hero'));
      }
     }
